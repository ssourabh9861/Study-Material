...
**Subtopic:** Redundancy, Failover & Multi-Region

Cover at minimum: redundancy models (N+1, 2N, active-active vs active-passive); failover mechanics and detection; multi-AZ vs multi-region; RTO/RPO; data replication across regions and the consistency tradeoff; DNS/anycast failover, health-checked routing; blast-radius containment, cell-based architecture, shuffle sharding; split-brain during failover; cost of redundancy; disaster recovery strategies.
