...
**Subtopic:** Eviction & Memory Management

Cover at minimum: eviction policies (LRU, LFU, FIFO, random, TTL, allkeys vs volatile) and how Redis approximates LRU/LFU; maxmemory policies and what happens at the limit; TTL/expiry mechanics (lazy + active expiration); memory fragmentation and jemalloc; sizing a cache and hit-ratio economics; cache pollution and scan resistance; admission policies (TinyLFU in Caffeine); measuring and tuning.
