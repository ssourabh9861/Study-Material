...
**Subtopic:** Modern Java Features

Cover at minimum: records (compact data carriers, canonical constructors); sealed classes/interfaces (controlled hierarchies); pattern matching for instanceof and switch (incl. record patterns); switch expressions; text blocks; var; the module system (JPMS) overview; useful API additions across LTS versions (8→11→17→21); how these change idiomatic senior Java; worked before/after examples.
