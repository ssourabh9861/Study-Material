...
**Subtopic:** Branching & Feature Flags

Cover at minimum: branching strategies (trunk-based development vs GitFlow vs GitHub Flow) and why trunk-based enables CI; short-lived branches and merge frequency; decoupling deploy from release via feature flags; feature-flag types (release, ops/kill-switch, experiment, permission); flag systems (LaunchDarkly, Unleash, OpenFeature); progressive rollout and targeting; flag debt/cleanup; testing with flags; worked examples.
