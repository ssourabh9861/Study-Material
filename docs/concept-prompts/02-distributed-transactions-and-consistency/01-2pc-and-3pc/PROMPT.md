...
**Subtopic:** Two-Phase & Three-Phase Commit (2PC/3PC)

Cover at minimum: the atomic commit problem; 2PC protocol step-by-step (prepare/commit, coordinator + participants, the log records each writes); the blocking problem and coordinator failure; 3PC and why it's rarely used; XA/JTA and distributed transactions in Java; where 2PC still lives (Spanner, some databases); why microservices avoid 2PC and what they use instead.
