...
**Subtopic:** Load Balancing & Service Discovery

Cover at minimum: L4 vs L7 load balancing; algorithms (round-robin, least-connections, EWMA/least-latency, consistent-hash, power-of-two-choices); health checks and outlier ejection; sticky sessions and when they hurt; client-side vs server-side LB; service discovery (DNS, Consul, Eureka, Kubernetes Services); global server load balancing/anycast; how LB interacts with autoscaling and retries.
