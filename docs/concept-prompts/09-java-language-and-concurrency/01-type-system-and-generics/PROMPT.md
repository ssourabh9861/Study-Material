...
**Subtopic:** Type System & Generics

Cover at minimum: Java's static type system; generics in depth (type parameters, bounded types, wildcards ? extends/super, PECS rule); type erasure and its consequences (no new T[], reflection limits, bridge methods); covariance/contravariance/invariance; reifiable vs non-reifiable types; common generic API design; var and type inference; sealed types interaction; pitfalls and worked examples.
