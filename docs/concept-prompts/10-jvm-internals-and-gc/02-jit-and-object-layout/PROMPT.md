...
**Subtopic:** JIT Compilation & Object Layout

Cover at minimum: interpretation vs JIT; tiered compilation (C1/C2), profiling, hot-spot detection, OSR; key optimizations (inlining, escape analysis + scalar replacement, lock elision, loop unrolling, devirtualization); deoptimization and why it happens; warmup and its impact on latency/benchmarks; reading -XX:+PrintCompilation/JITWatch; how object layout/field alignment/padding affect performance (false sharing); practical implications for hot paths.
