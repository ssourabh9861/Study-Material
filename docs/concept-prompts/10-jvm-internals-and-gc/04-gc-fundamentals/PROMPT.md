...
**Subtopic:** Garbage Collection Fundamentals

Cover at minimum: why GC exists; reachability and GC roots; the generational hypothesis; mark-sweep, mark-compact, copying collectors; minor vs major vs full GC; stop-the-world pauses and safepoints (what they are, safepoint bias); allocation (TLABs), promotion, tenuring; remembered sets and card tables (how cross-gen references are tracked); write barriers; the throughput vs latency vs footprint trilemma.
