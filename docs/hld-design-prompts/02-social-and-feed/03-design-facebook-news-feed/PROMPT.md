...
Focus deep dives on: feed aggregation from many sources; ranking/relevance pipeline (signals, ML scoring service) at a systems level; fan-out strategy; edge ranking; pagination of an infinite feed; freshness vs cost; dedup and story injection; caching layers.
