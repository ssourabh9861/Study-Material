...
Focus deep dives on: media transport (WebRTC, UDP) at a systems level; SFU vs MCU vs mesh topologies and the tradeoff; signaling servers; handling NAT traversal (STUN/TURN — explain); bandwidth adaptation/simulcast; recording; scaling to large meetings/webinars; regional media servers and latency.
