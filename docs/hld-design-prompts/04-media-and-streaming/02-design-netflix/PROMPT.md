...
Focus deep dives on: content ingestion/transcoding pipeline; **CDN / Open Connect** and edge caching strategy (pre-positioning popular content); adaptive bitrate; the metadata/catalog service; recommendations service boundary; viewing history/bookmarks; A/B testing infra; multi-region availability; cost of bandwidth.
