...
**System:** Design an Image Hosting Service + CDN

Focus deep dives on: upload pipeline + dedup (content hashing); blob/object storage layout; on-the-fly vs precomputed image resizing/transformations; CDN caching, cache keys, and invalidation; metadata DB; hotlinking/abuse protection; signed URLs; cost optimization for storage tiers.
