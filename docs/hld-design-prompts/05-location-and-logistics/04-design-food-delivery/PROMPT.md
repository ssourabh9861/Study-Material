...
**System:** Design a Food Delivery System (Swiggy/DoorDash)

Focus deep dives on: the three-sided system (customer, restaurant, delivery partner); order lifecycle state machine; live order + courier tracking (location streaming); courier assignment/dispatch optimization; restaurant availability/menu; ETA prediction; surge and batching of orders; consistency of order state; payments integration boundary.
