...
Focus deep dives on: short-key generation (counter+base62 vs hashing vs **pre-generated key service**) and collision avoidance; the read-heavy redirect path (caching, CDN); storage choice and scale; custom aliases; analytics; expiration; 301 vs 302; sharding the key space.
