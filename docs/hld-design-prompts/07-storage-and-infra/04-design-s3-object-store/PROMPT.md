...
**System:** Design S3 / an Object Store

Focus deep dives on: the object/bucket model; durability via replication/erasure coding (explain erasure coding); the metadata layer vs data layer; consistent hashing for placement; multipart upload; strong-read-after-write consistency; handling hot objects; background repair/anti-entropy; scaling to exabytes.
