...
**System:** Design a Proximity Service (Yelp / nearby places)

Focus deep dives on: storing and querying places by location; geospatial index choices (geohash vs quadtree vs S2) and their tradeoffs for "find within radius / k-nearest"; read-heavy serving + caching; ranking by distance/rating; handling dense vs sparse regions; updates to business data; consistency vs freshness.
