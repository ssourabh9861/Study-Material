...
**System:** Design a Web Crawler

Focus deep dives on: the crawl frontier (URL queue) and prioritization; politeness (per-domain rate limiting, robots.txt); **dedup of URLs and content** (bloom filters, content hashing); distributed workers and coordination; freshness/recrawl policy; trap avoidance; storage of crawled data; scaling to billions of pages.
