...
**System:** Design a Distributed Message Queue (like Kafka)

Focus deep dives on: the partitioned log, ordering, and offsets; replication (ISR) and durability; producer/consumer groups; delivery semantics (at-least/exactly-once); retention; backpressure; the metadata/controller; comparison to a traditional broker; how you'd build the core yourself; scaling throughput.
