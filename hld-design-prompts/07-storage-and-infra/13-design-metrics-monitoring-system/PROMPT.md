...
**System:** Design a Metrics & Monitoring System (Prometheus-like)

Focus deep dives on: metric ingestion at scale; the **time-series database** design (compression, downsampling, retention tiers); pull vs push collection; cardinality explosion and how to bound it; querying/aggregation; alerting pipeline; long-term storage; high availability of the monitoring system itself; dashboarding boundary.
