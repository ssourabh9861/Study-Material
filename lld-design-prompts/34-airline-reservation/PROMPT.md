...
**LLD Problem:** Airline Reservation System
Likely patterns/focus: State (booking), Strategy (fare/seat pricing), concurrency for **seat booking**, Factory. Entities: Flight, Aircraft, Seat, Itinerary, Booking, Passenger, Payment.
Extensions to address: search flights (one-way/round/multi-city), seat selection & double-booking prevention, fare classes/pricing, cancellations/changes, overbooking, layovers, concurrency.
